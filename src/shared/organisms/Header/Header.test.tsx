...
describe('Header', () => {
  it('renders title, subtitle, and ThemeToggle', () => {
    render(<Header title="Expense Tracker" subtitle="Track your expenses effortlessly" />);
    expect(screen.getByText('Expense Tracker')).toBeInTheDocument();
    expect(screen.getByText('Track your expenses effortlessly')).toBeInTheDocument();
